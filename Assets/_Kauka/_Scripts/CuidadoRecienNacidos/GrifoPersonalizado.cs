...
public class GrifoPersonalizado : MonoBehaviour
{
    ...
    [SerializeField] OnTriggerEvent triggerHands;
    ...
    public void ComprobarRotacionManivela()
    {
        ...
        {
            if (triggerHands.gameObject.activeInHierarchy == false && !triggerHands.disable)
            {
                triggerHands.gameObject.SetActive(true);
            }
        ...
        else
        {
            ...
            if (triggerHands.gameObject.activeInHierarchy == true)
            {
                triggerHands.gameObject.SetActive(false);
            }
