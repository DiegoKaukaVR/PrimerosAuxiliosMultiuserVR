...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class DobleXRController : XRBaseController
    {
        [SerializeField]
        ...
        protected override void UpdateInput(XRControllerState controllerState)
        {
            ...
            if(!IsPressed(m_SelectUsage))
            {
                controllerState.selectInteractionState.SetFrameState(IsPressed(m_ActivateUsage), ReadValue(m_ActivateUsage));
            }
            else
            {
